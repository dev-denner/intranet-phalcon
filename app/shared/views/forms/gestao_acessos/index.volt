...
<div class="card">
    ...
    <div class="card-body card-padding">
        <div class="row">
            {{ form('forms/gestao_acessos', 'role': 'form', 'method': 'post', 'autocomplete': 'off', 'onsubmit': 'overlay(true)') }}
            <div class="col-sm-6">
            ...
            <div class="col-sm-1 col-sm-offset-4">
                <div class="form-group">
                    {{ link_to('forms/gestao_acessos/new', 'Novo', 'class': 'btn btn-success btn-sm m-t-5 waves-effect') }}
                    <br class="visible-xs-block" />
                    <br class="visible-xs-block" />
                </div>
            </div>
            ...
            <table class="table table-striped table-vmiddle datatable">
                <thead>
                    <tr>
                        ...
                        <th data-column-id="nomeFormulario">Fomulário</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ gestao_acesso.nomeFormulario }}</td>
                        <td>{{ gestao_acesso.users.name }}</td>
                        <td>{{ gestao_acesso.amarracao }}</td>
                        <td>{{ static_url('forms/gestao_acessos') }}</td>
                    </tr>
                    {% endfor %}
                </tbody>
            </table>
