...
<div class="card">
    <div class="card-header">
        <h2>Arquivos Adicionados
            {{ link_to('forms/coleta_rescisao', 'Voltar', 'class': 'btn btn-success btn-sm m-t-5 waves-effect pull-right') }}
        </h2>

    </div>
    <div class="card-body card-padding">
        {% for file in files %}
        {{ link_to('downloads/coleta_rescisao/'~sequence~'/'~file, file, 'class': 'btn btn-primary btn-sm m-t-5 waves-effect', 'target': '_blank') }}
        {% endfor %}
    </div>
</div>
