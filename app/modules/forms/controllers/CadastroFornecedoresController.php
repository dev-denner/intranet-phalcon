...
class CadastroFornecedoresController extends ControllerBase
{
    ...
    {
        $this->tag->setTitle('Formulário de Cadastro de Fornecedores');
        parent::initialize();
    }
    ...
    public function indexAction()
    {
        ...
        $this->assets->collection('footerJs')->addJs('app/forms/cadastro_fornecedores/index.js');
    }
    ...
    public function sendFormAction()
    {
        try {
            if ($this->request->isPost()) {
                ...
                $subject = 'Solicitação Cadastro de Fornecedores';
                ...
                $options['log'] = [
                    ...
                    'identKey' => 'Sistema: ' . $this->request->getPost('Sistema') . ' - ' .
        ...
        return $this->response->redirect('forms/cadastro_fornecedores/');
    }
