...
class FormTab extends ModelBase
{
    ...
    public function initialize()
    {
        ...
        $this->belongsTo('form', __NAMESPACE__ . '\Forms', 'id', ['alias' => 'Forms']);
        $this->hasMany('id', __NAMESPACE__ . '\FormSection', 'tab', ['alias' => 'FormSection']);
    ...
    {
        return array(
            'ID_F_FORMULARIO_ABA' => 'id',
            'CD_F_FORMULARIO' => 'form',
            'NM_NOME' => 'name',
            'NO_POSICAO' => 'position',
            'CD_TIPO' => 'type',
            'SDEL' => 'sdel',
