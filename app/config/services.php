...
$di->setShared('router', function () use ($config) {
  ...
  $router->add('/nucleo', array(
      'module' => 'Nucleo',
      'controller' => 'index',
      'action' => 'index'
  ))->setName('nucleo-index');

  $router->add('/nucleo/:controller', array(
      'module' => 'Nucleo',
      'controller' => 1,
      'action' => 'index'
  ))->setName('nucleo-controller');

  $router->add('/nucleo/:controller/:action/:params', array(
      'module' => 'Nucleo',
      'controller' => 1,
      'action' => 2,
      'params' => 3
