...
$rm = '(DESCRIPTION = (ADDRESS = (PROTOCOL = TCP)(HOST = 192.168.1.9)(PORT = 1521))
    (CONNECT_DATA = (SERVER = DEDICATED) (SERVICE_NAME = ORAINST3)))';

$protheus = '(DESCRIPTION = (ADDRESS = (PROTOCOL = TCP)(HOST = 192.168.1.9)(PORT = 1521))
    (CONNECT_DATA = (SERVER = DEDICATED) (SERVICE_NAME = ORAINST1)))';

$mpeProd = '(DESCRIPTION = (ADDRESS = (PROTOCOL = TCP)(HOST = 192.168.1.205)(PORT = 1521))
...
return new \Phalcon\Config(array(
    'database' => array(
        ...
        'rmDb' => array(
            'adapter' => 'Oracle',
            'host' => '192.168.1.9:1521:ORAINST3',
            'username' => 'RM',
            'password' => 'rm',
            'dbname' => $rm,
            'charset' => 'utf8',
        ...
        'protheusDb' => array(
            'adapter' => 'Oracle',
            'host' => '192.168.1.9:1521:ORAINST1',
            'username' => 'PROTHEUS',
            'password' => 'protheus',
            'dbname' => $protheus,
            'charset' => 'utf8',
        ...
        'cnabDb' => array(
            'adapter' => 'Oracle',
            'host' => '192.168.1.205:1521:MPEPROD',
            'username' => 'CNAB',
            'password' => 'cnab',
            'dbname' => $mpeProd,
            'charset' => 'utf8',
